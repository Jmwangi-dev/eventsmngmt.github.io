    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - <?php echo $_SESSION['system']['name'] ?> | <a class="text-success"  target="_blank">Jmwangi</a></div></div>
        </footer>
